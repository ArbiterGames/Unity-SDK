...
@implementation ArbiterSCOfficialRules
...
- (void)renderMessage
{
    ...
    [self.arbiter httpGet:url isBlocking:YES handler:[^(NSDictionary *responseDict) {
        ...
        ArbiterSCRulesTableViewDelegate *tableDelegate = [[ArbiterSCRulesTableViewDelegate alloc] initWithMessage:message];
        ArbiterUITableView *tableView = [[ArbiterUITableView alloc] initWithFrame:CGRectMake(0.0, 60.0, self.frame.size.width, tableHeight)];
